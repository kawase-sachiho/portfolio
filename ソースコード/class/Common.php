...
class Info
{
    ...
    /* 数値から３年目未満のスタッフでも対応可能かを判定して文字列で表示するメソッド(配列から数値データを取り出す場合)
    @param  $patient array
    @return ３年目未満のスタッフでも対応可能か表す文字列
    @var    str */
