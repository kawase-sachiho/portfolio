...
<body>
    <div class="container">
        ...
        <h1 class="my-5 text-center text-warning"><u>スタッフ介入表</u></h1>
        <form method="post" action="./today.php">
            ...
            <div class="row my-3">
                <div class="col-3"></div>
                <div class="col-5"></div>
                <button type="submit" class="btn btn-danger btn-lg text-white">表示</button>
            </div>
        </form>
        ...
        <?php if (isset($staffs)) : ?>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($staffs as $staff) : ?>
                                    <tr>
                                        ...
                                        <td class="col-auto">
                                            <?php
                                            echo $staff['patient_name1'] . " " . $staff['today_staff_num1'] . " ";
                                            echo $staff['patient_name2'] . " " . $staff['today_staff_num2'] . " ";
                                            echo $staff['patient_name3'] . " " . $staff['today_staff_num3'] . " ";
                                            echo $staff['patient_name4'] . " " . $staff['today_staff_num4'] . " ";
                                            echo $staff['patient_name5'] . " " . $staff['today_staff_num5'] . " ";
                                            echo $staff['patient_name6'] . " " . $staff['today_staff_num6'] . " ";
                                            echo $staff['patient_name7'] . " " . $staff['today_staff_num7'] . " ";
                                            echo $staff['patient_name8'] . " " . $staff['today_staff_num8'] . " ";
                                            echo $staff['patient_name9'] . " " . $staff['today_staff_num9'] . " ";
                                            echo $staff['patient_name10'] . "" . $staff['today_staff_num10'] . " ";
                                            ?>
                                        </td>
                                        <td class="col-auto">
            ...
            <?php endif ?>
            <a class="btn btn-primary text-white btn-lg" style="text-decoration:none;" href="./base.php">担当患者一覧表へ</a>
